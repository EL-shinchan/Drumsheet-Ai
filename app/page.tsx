    ...
    <main className="min-h-screen bg-slate-950 text-slate-100">
      <div className="mx-auto max-w-4xl px-6 py-12">
        <section className="mb-8">
          <h1 className="text-4xl font-bold tracking-tight">AI Drum Sheet Generator</h1>
        ...
        <div className="space-y-5">
          <UploadBox onFileChange={setFile} selectedFile={file} disabled={loading} />
          <DifficultySelector value={difficulty} onChange={setDifficulty} disabled={loading} />
          <GenerateButton onClick={handleGenerate} loading={loading} disabled={!file || !difficulty} />
